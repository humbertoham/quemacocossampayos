            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div className='hidden xl:ml-6 xl:block text-white'>
                  ...
                  <h1>Email: quemacocossampayos@gmail.com</h1>
                  
                </div>
                <div className='hidden xl:ml-6 xl:block text-white'>
                <PhoneIcon className='icon'/>
                  <h1>Número:+52 56 1267 08649</h1>
                  </div>
                  <div className='hidden sm:ml-6 sm:block'>
                  <a href='https://www.facebook.com/profile.php?id=100077511617107' target="_blank"> <FaFacebook className = 'iconfa'/> </a>
                  </div>
